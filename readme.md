...
This application’s origination was to satisfy the requirements of Florida Blue’s coding
exercise.  The application is a starter app that will soon document Seattle-area
hiking trails hiked by the developer.  In its present state the application utilizes Spring 
Boot (version 2.5.0-RC1, Spring 5x), and is a Maven project.  Later the developer will 
...
incorporate a UI, possibly to provide an Android app as well.  For general assumptions, 
see the project’s pom.xml build file.  The program utilizes a H2 in-memory database.  
Also, the application utilizes Java 8 apis.  The app supports the following Rest apis.
Unit/integration tests are incorporated to test the apis.
